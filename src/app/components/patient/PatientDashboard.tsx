    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link to="/patient/booking">
          <div className="bg-gradient-to-r from-green-600 to-green-500 text-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all cursor-pointer">
        ...
        <Link to="/patient/messages">
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all cursor-pointer">
        ...
        {upcomingAppointments.length > 0 ? (
          <div className="space-y-4">
            {upcomingAppointments.map((slot) => (
              <div
                key={slot.id}
                className="flex items-center justify-between p-4 bg-green-50 border-l-4 border-green-600 rounded-lg"
              >
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-green-600 rounded-lg flex flex-col items-center justify-center text-white">
