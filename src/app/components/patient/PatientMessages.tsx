  ...
  return (
    <div className="space-y-3 max-w-3xl">
                ...
                {doctors.map((doc) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 text-sm hover:bg-gray-50 transition-colors ${
                      doc.id === selectedDoctorId ? "text-brand-600 font-semibold" : "text-gray-700"
                    }`}
                  >
                    {doc.full_name}
                  </button>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col h-[480px]">
        {/* Chat header */}
        <div className="flex items-center gap-3 px-4 py-2.5 border-b bg-brand-600 rounded-t-xl">
          {selectedDoctor ? (
            <>
              ...
              <div>
                ...
                <p className="text-xs text-brand-100">Kinésithérapeute D.E.</p>
              </div>
              <span className="ml-auto flex items-center gap-1 text-xs text-brand-100">
              ...
              return (
                <div key={msg.id} className={`flex items-end gap-2 ${isMine ? "justify-end" : "justify-start"}`}>
                  ...
                  >
                    ...
                    <div className={`flex items-center gap-1 mt-0.5 justify-end text-[10px] ${isMine ? "text-brand-200" : "text-gray-400"}`}>
        ...
        <form onSubmit={handleSend} className="p-3 border-t bg-white rounded-b-xl">
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 text-sm px-3 py-2 border border-gray-300 rounded-lg focus:border-brand-500 focus:ring-1 focus:ring-brand-500 focus:outline-none"
