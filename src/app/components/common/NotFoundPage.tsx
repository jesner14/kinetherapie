  ...
  return (
    <div className="min-h-[65vh] flex items-center justify-center px-6 py-16">
      <div className="max-w-lg w-full text-center bg-white border border-gray-200 rounded-2xl shadow-sm p-8">
        ...
        <p className="text-xs font-semibold uppercase tracking-wider text-green-700 mb-2">Erreur 404</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link to="/" className="px-4 py-2.5 rounded-xl bg-green-600 text-white font-semibold hover:bg-green-700 transition-colors">
            Retour a l'accueil
          </Link>
